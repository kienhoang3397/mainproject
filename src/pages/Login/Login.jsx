...
import { FormInputPassword, FormInputUsername } from '../../common/components/Forms/FormInput/FormInput'
...
function LoginPage() {
    return (
        ...
        <div className='loginPageContainer'>
            <section className='imgLogin'><img src="https://i.ibb.co/hFXwLcv/imgLogin.png" alt="" /></section>
            <section className='formLogin'>    <Theme greyText width={'1000px'} height={'100px'} />
                <p className='textLogin'>Login</p>
                <FormInputUsername />
                <FormInputPassword />
                <p className='forgotPassword'>Forgot password?</p>
                
                    <Btn defaultValue content={'Login'} />
                

                <section className='shapeForm'>
                    <div className='shapeW'></div>
                    <p className='shapeFormText'>OR</p>
                    <div className='shapeW'></div>

                </section>
                <section className='googleSignup'>
                    ...
                    <p className='googleSignupContent'>Continute with Google</p>

                </section>
                <section className='questionSignup'><p className='question'>Don't have an account?</p><p className='signupNow'>Sign up now</p></section>
            </section>
